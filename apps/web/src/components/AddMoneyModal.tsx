...
export function AddMoneyModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md animate-fade-up overflow-hidden border border-[#EADFC8]">
        {/* Header */}
        <div className="p-6 pb-4">
          <div className="flex items-start justify-between">
            ...
            <button
              onClick={onClose}
              className="text-[#8A9270] hover:bg-[#FFF8EC] hover:text-[#546B41] w-8 h-8 rounded-lg flex items-center justify-center transition-colors"
            >
              <svg
                width="18"
                height="18"
