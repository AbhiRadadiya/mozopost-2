      ...
      <div className="relative w-full max-w-[600px] aspect-square">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white shadow-lg shadow-indigo-200">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 2a2 2 0 0 1 2 2v2a2 2 0 0 1-4 0V4a2 2 0 0 1 2-2z"></path><path d="M20 10v2a8 8 0 0 1-16 0v-2"></path><line x1="12" y1="20" x2="12" y2="23"></line><line x1="8" y1="23" x2="16" y2="23"></line></svg>
            </div>
            <div>
              <div className="text-[10px] font-bold text-indigo-600 uppercase tracking-wider">Servam AI Engine</div>
              <div className="text-sm font-bold text-gray-900">AI NDR Resolution</div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2 text-xs font-medium text-gray-600 bg-white/50 p-2 rounded-lg border border-white">
               <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse" /> Calling buyer to confirm delivery...
            </div>
            <div className="flex justify-between items-center px-1">
              <div className="text-[10px] text-gray-500 font-semibold">RTO Reduced By</div>
        ...
        <div className="absolute top-[12%] right-[5%] z-20
          ...
          <div className="flex items-center justify-between mb-3">
             ...
             <div className="text-[10px] font-bold text-green-600 bg-green-100 px-2 py-0.5 rounded-full">Early COD</div>
          </div>
          <div className="text-xs font-semibold text-gray-500 mb-0.5">Wallet Balance</div>
          <div className="text-lg font-black text-gray-900 font-mono">₹1,24,500</div>
        </div>

        {/* ── Bottom Left: 15+ Couriers ── */}
        <div className="absolute bottom-[15%] left-[8%] z-40
             w-[240px] bg-white/80 backdrop-blur-xl border border-white/80 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] 
             rounded-2xl p-4"
             style={{ animation: "float 7s ease-in-out infinite", animationDelay: "2.5s" }}>
          <div className="text-[11px] font-bold text-gray-800 uppercase tracking-widest mb-3">15+ Courier Partners</div>
          <div className="grid grid-cols-4 gap-2">
            {[1,2,3,4].map((i) => (
              <div key={i} className="aspect-square bg-gray-50 rounded-xl border border-gray-100 flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="2.5"><rect x="1" y="3" width="15" height="13"></rect><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"></polygon><circle cx="5.5" cy="18.5" r="2.5"></circle><circle cx="18.5" cy="18.5" r="2.5"></circle></svg>
              </div>
            ))}
          </div>
        ...
        <div className="absolute top-[25%] left-[5%] z-10
          ...
          <span className="text-xs font-bold text-gray-800">Branded Tracking & Alerts</span>
        </div>

        {/* ── Connecting animated dashes (Optional) ── */}
        <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
           <path d="M 300 250 C 400 150, 450 150, 500 100" fill="none" stroke="#6366F1" strokeWidth="1.5" strokeDasharray="4 6" opacity="0.3" className="animate-dash" />
           <path d="M 300 350 C 200 450, 200 500, 150 550" fill="none" stroke="#10B981" strokeWidth="1.5" strokeDasharray="4 6" opacity="0.3" className="animate-dash-reverse" />
        </svg>
      </div>
...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      else if (user.role === "super_admin") router.push("/dashboard/superadmin");
      ...
      <div className="flex w-full lg:w-[45%] items-center justify-center px-8 py-10 relative z-10 border-r border-gray-100 shadow-[10px_0_40px_rgba(0,0,0,0.02)] bg-white">
        ...
        <div className="w-full max-w-[380px]">
          ...
          <div className="flex items-center gap-3 mb-10">
            ...
            <div className="font-bold text-gray-900 text-xl tracking-tight">Mozopost</div>
          </div>

          {/* Heading */}
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Login</h1>
            <p className="text-sm text-gray-500">We suggest using the email address you use at work.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="text-right mt-1.5">
                <Link href="/forgot-password" className="text-[12px] text-gray-500 hover:text-gray-800 transition-colors">
                  Forgot password
                </Link>
              </div>
            </div>
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-[11px] uppercase tracking-wider font-semibold text-gray-400">OR</span>
            <div className="flex-1 h-px bg-gray-200"/>
          </div>

          {/* Social Logins */}
          <div className="space-y-3">
            <button type="button" className="w-full py-2.5 bg-white border border-gray-200 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 shadow-sm">
          ...
          <div className="mt-8 text-center text-[13px] text-gray-500">
            ...
            <Link href="/register" className="font-semibold text-[#6366F1] hover:text-[#4F46E5] transition-colors">
              Sign up
            </Link>
          </div>
