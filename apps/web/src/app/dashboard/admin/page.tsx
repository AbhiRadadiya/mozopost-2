    ...
    return (
      <div className="flex h-[400px] items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-sm font-medium text-[#64748B] animate-pulse">
            Loading overview...
          </div>
        </div>
      </div>
    ...
    <div className="animate-fade-up  mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-[#64748B] mt-1">
          Real-time stats across all merchants and operations.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <div className="bg-gradient-to-br from-[#0F172A] to-[#1E293B] p-5 rounded-2xl shadow-sm border border-[#334155] hover:border-[#475569] transition-colors group relative overflow-hidden">
          ...
          <div className="text-2xl font-bold text-white font-mono relative z-10">
            ₹
            {(stats?.total_margin ?? 0).toLocaleString("en-IN", {
              maximumFractionDigits: 0,
            })}
          </div>
        </div>
        ...
        <div className="bg-[#FEF2F2] p-5 rounded-2xl shadow-sm border border-[#FECACA] hover:border-[#FCA5A5] transition-colors group">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="text-[10px] font-bold text-[#991B1B] uppercase tracking-widest">
              RTO
            </div>
          </div>
          <div className="text-2xl font-bold text-[#991B1B] font-mono">
            {stats?.total_rto ?? 0}
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <Link
            ...
            className="group p-5 bg-white rounded-2xl border border-[#E5E8EF] shadow-sm hover:shadow-md hover:-translate-y-1 hover:border-[#CBD5E1] transition-all"
          >
          ...
          >
            ...
            <p className="text-xs text-[#64748B]">
              Credit, debit, and review seller wallet ledgers.
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-xs text-[#64748B]">
              Configure base shipping costs and profit margins.
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-xs text-[#64748B]">
              Process Cash-on-Delivery remittances to sellers.
            </p>
          </Link>
        </div>
      </div>
