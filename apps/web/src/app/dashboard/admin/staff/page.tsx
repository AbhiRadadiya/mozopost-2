      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-[#64748B] mt-1">
            Manage admin and staff access to the platform.
          </p>
        </div>
        <button
            ...
            <tbody className="divide-y divide-[#F1F5F9]">
              {staff.map((s) => (
                <tr key={s.id} className="hover:bg-[#F8F9FB] transition-colors">
                  ...
                  <td className="px-5 py-3.5">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-semibold ${ROLE_STYLE[s.role] || "bg-[#F1F5F9] text-[#475569]"}`}
                    >
                      {s.role.replace("_", " ")}
                    </span>
                  </td>
                  <td className="px-5 py-3.5">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-semibold ${s.status === "active" ? "bg-[#D1FAE5] text-[#065F46]" : "bg-[#F1F5F9] text-[#475569]"}`}
                    >
                      {s.status}
                    </span>
                  </td>
