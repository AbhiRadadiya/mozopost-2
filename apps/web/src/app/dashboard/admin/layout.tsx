    ...
    items: [
      {
        ...
        label: "Rate Cards",
        icon: "M4 5a1 1 0 011-1h14a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V5zm5-1v16m6-16v16M4 9h16M4 15h16",
      },
      {
              ...
              {group.items.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`
                      flex items-center gap-3 px-[13px] py-[10px] rounded-[7px] transition-all duration-150 group text-[14px]
                  ...
                  >
                    ...
                    {!collapsed && (
                      <span
                        className={`leading-none truncate text-[13.5px] ${active ? "font-bold text-white" : ""}`}
                      >
                        {item.label}
                      </span>
                    )}
