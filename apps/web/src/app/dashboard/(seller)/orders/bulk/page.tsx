              ...
              <div className="p-6">
                ...
                >
                  ...
                  <p className="text-sm text-[#64748B]">
                    Max 500 rows per file. File must match the template format.
                  </p>
                </div>
              </div>
            )}
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="bg-[#F0FDF4] p-4 rounded-xl border border-[#BBF7D0]">
                    ...
                    <div className="text-2xl font-bold text-[#16A34A] font-mono">
                      {SAMPLE_ROWS.filter((r) => r.status === "valid").length}
                    </div>
                  </div>
                  <div className="bg-[#FEF2F2] p-4 rounded-xl border border-[#FECACA]">
                    ...
                    <div className="text-2xl font-bold text-[#EF4444] font-mono">
                      {SAMPLE_ROWS.filter((r) => r.status === "error").length}
                    </div>
                  </div>
                </div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                      <thead className="bg-[#F8F9FB] border-b border-[#E5E8EF]">
                        <tr>
                          <th className="px-4 py-3 text-left text-[10px] font-bold text-[#94A3B8] uppercase tracking-widest w-12">
                            #
                          </th>
                          <th className="px-4 py-3 text-left text-[10px] font-bold text-[#94A3B8] uppercase tracking-widest">
                            Order ID
                          </th>
                          <th className="px-4 py-3 text-left text-[10px] font-bold text-[#94A3B8] uppercase tracking-widest">
                            Name
                      ...
                      <tbody>
                        {SAMPLE_ROWS.map((r) => (
                          <tr
                            key={r.row}
                            className={`border-b border-[#F1F3F7] last:border-0 ${r.status === "error" ? "bg-[#FEF2F2]" : "hover:bg-[#F8F9FB]"} transition-colors`}
                          >
                            <td className="px-4 py-3.5 font-mono text-xs text-[#64748B]">
                              {r.row}
                            </td>
                            <td className="px-4 py-3.5 font-mono text-xs font-bold text-[#0F172A]">
                              {r.orderId}
                            </td>
                            <td className="px-4 py-3.5 text-xs font-medium text-[#0F172A]">
                              {r.name}
                            </td>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-[#E5E8EF] overflow-hidden">
            ...
            <div className="p-0">
              <table className="w-full text-xs">
                <thead className="bg-[#F8F9FB] border-b border-[#E5E8EF]">
                  <tr>
                    <th className="px-4 py-3 text-left font-bold text-[#94A3B8] uppercase tracking-widest text-[9px]">
                      Date
                    </th>
                    <th className="px-4 py-3 text-left font-bold text-[#94A3B8] uppercase tracking-widest text-[9px]">
                      File
                ...
                <tbody className="divide-y divide-[#F1F3F7]">
                  <tr className="hover:bg-[#F8F9FB]">
                    <td className="px-4 py-3 text-[#475569] font-medium whitespace-nowrap">
                      01 Jun
                    </td>
                    <td className="px-4 py-3 font-mono text-[10px] text-[#0F172A] font-medium truncate max-w-[100px]">
                      orders_jun1.csv
                    </td>
