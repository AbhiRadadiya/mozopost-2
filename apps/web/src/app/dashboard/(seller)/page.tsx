    ...
    <div className="space-y-6 animate-fade-up">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-3.5">
        ...
        <StatCard
          ...
          value={
            stats?.total_cod
              ? `₹${(stats.total_cod * 1.2).toLocaleString("en-IN")}`
              : "₹9,20,181"
          }
        ...
        <StatCard
          ...
          value={
            stats?.total
              ? `${((stats.in_transit / stats.total) * 100).toFixed(2)}%`
              : "50.53%"
          }
        ...
        <StatCard
          ...
          value={
            stats?.total
              ? `${((stats.rto / stats.total) * 100).toFixed(2)}%`
              : "39.54%"
          }
          subLabel="Orders RTO"
            ...
            <div style={{ width: "148px", height: "148px", flexShrink: 0 }}>
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                    data={
                      paymentDonutItems.length
                        ? paymentDonutItems
                        : [{ label: "NO DATA", value: 1, color: "#EADFC8" }]
                    }
                    cx="50%"
                    cy="50%"
                    innerRadius={38}
            ...
            <div style={{ width: "148px", height: "148px", flexShrink: 0 }}>
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                    data={
                      confirmationDonutItems.length
                        ? confirmationDonutItems
                        : [{ label: "NO DATA", value: 1, color: "#EADFC8" }]
                    }
                    cx="50%"
                    cy="50%"
